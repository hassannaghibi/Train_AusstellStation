...
def main(input, step_over, to_index, from_index, group_count, export_chart_path, export_file_path):
    ...
    header = ["Model Run ID", "Crane ID", "Time Spent Idle (minutes)", "Time On Work Orders (minutes)", "Lift Count"]
...
print("start")
url = "C:/Users/Hassan/Desktop/pythonExport/VisualizationOverHeadCraneHourlyData/"
main(url + 'input.txt', 1, 2, 5, 6, url + "result/",
